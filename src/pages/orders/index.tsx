...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user_order_customer_idTouser', 'user_order_wait_staff_idTouser', 'restaurant'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_order_customer_idTouser',
          header: 'User Order Customer Id Touser',
          accessorKey: 'user_order_customer_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_order_customer_idTouser?.id}`}
            >
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_order_wait_staff_idTouser',
          header: 'User Order Wait Staff Id Touser',
          accessorKey: 'user_order_wait_staff_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_order_wait_staff_idTouser?.id}`}
            >
