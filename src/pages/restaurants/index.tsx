  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'menu.count', 'order.count', 'reservation.count', 'table.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'address', header: 'Address', accessorKey: 'address' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.open_hours ? format(record?.open_hours, 'dd-MM-yyyy') : '',
    },
    {
      id: 'close_hours',
      header: 'Close Hours',
      accessorKey: 'close_hours',
      cell: ({ row: { original: record } }: any) =>
        record?.close_hours ? format(record?.close_hours, 'dd-MM-yyyy') : '',
    },
